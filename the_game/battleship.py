...
class game:
    ...
    def draw_gameover_text(self, screen):
        ...
        if len(self.opponent_hits) == 17:
            text1 = font.render("You've lost! ...", True, (255,255,255))
        else:
            text1 = font.render("You've won! ...", True, (255,255,255))
    ...
    def draw_player2(self, screen, player2):
        if self.player_ready == True and player2.player_ready == True:
            ...
            text1 = font1.render("Opponent", True, (255,255,255))
    ...
    def draw_text(self, screen, player2):
        ...
        if self.player_ready == False and player2.gameover == True:
            text2 = font2.render("Waiting for opponent to reset ...", True, (255,255,255))
            ...
            text2 = font2.render("Waiting on Opponent ...", True, (255,255,255))
        elif self.player_ready == False and player2.player_ready == True:
            text2 = font2.render("Opponent is Ready...", True, (255,255,255))
        else:
            if self.turn == True:
                text2 = font2.render("Left click on grid to strike!...", True, (255,255,255))
            else:
                text2 = font2.render("Waiting on opponent to strike...", True, (255,255,255))
